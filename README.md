...
Based on the Debian 5.15.0 kernel package (Linux kernel 5.15.0), and the work from JAMESMTL:
...
cd /usr/src
sudo git clone -b debian11-5.10 https://github.com/jrhopper/bnx2x-2_5g-dkms.git bnx2x-99.1.713.36-0
